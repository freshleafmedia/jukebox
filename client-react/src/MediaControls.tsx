...
class MediaControls extends Component {
    ...
    playIsEnabled () {
        return this.props.songs.length > 0 && typeof this.props.songs.find(song => song.props.playState === 'playing') === 'undefined';
    }

    pauseIsEnabled () {
        return this.props.songs.length > 0 && typeof this.props.songs.find(song => song.props.playState === 'paused') === 'undefined';
    }
