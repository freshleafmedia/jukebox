...
},{"./controllers/ApplicationController.js":4,"jquery":13}],2:[function(require,module,exports){
'use strict';
...
var ApplicationController = function () {
    ...
    _createClass(ApplicationController, [{
        ...
        value: function setupSockets() {
            ...
            this.socket.on('mostPlayed', function (data) {
                _this.mostPlayedController.updateList(data);
            });
            ...
            this.socket.on('jukeboxState', function (state) {
                if (state === 'playing') {
...
},{"../helpers/google.js":10,"../helpers/notifications.js":11,"./MostPlayedController.js":5,"./PlaylistController.js":6,"./SearchController.js":7,"./SoundbitesController.js":8,"jquery":13}],5:[function(require,module,exports){
"use strict";
...
var MostPlayedController = function () {
    function MostPlayedController(socket, googleApi) {
        _classCallCheck(this, MostPlayedController);
    ...
    _createClass(MostPlayedController, [{
        key: 'updateList',
        value: function updateList(songs) {
            this.googleApi.onInit(function () {
                var _this = this;

                this.addMetaData(songs, function (songs) {
                    _this.updateMarkup(songs);
                });
            }.bind(this));
        }
    }, {
        key: 'addMetaData',
        value: function addMetaData(songs, callback) {
            this.updateMetaDataCache(songs, function () {
                songs = songs.map(function (item) {
                    var song = this.metaDataCache[item.id];
        ...
        key: 'updateMetaDataCache',
        value: function updateMetaDataCache(songs, callback) {
            var _this2 = this;

            var songIdsToCache = songs.reduce(function (ids, item) {
                if (!_this2.metaDataCache[item.id]) {
                    ids.push(item.id);
                    return ids;
                }
                return ids;
        ...
        key: 'updateMarkup',
        value: function updateMarkup(songs) {
            this.container.innerHTML = '';
            for (var i = 0; i < songs.length; i++) {
                var elem = songHelper.buildSongMarkup(songs[i]);
    ...
    return MostPlayedController;
}();

exports.default = MostPlayedController;

},{"../helpers/songs.js":12,"jquery":13}],6:[function(require,module,exports){
'use strict';
...
},{"../helpers/songs.js":12,"jquery":13}],7:[function(require,module,exports){
'use strict';
...
var SearchController = function () {
    function SearchController(socket, googleApi) {
    ...
    _createClass(SearchController, [{
        ...
        value: function initKeyEvents() {
            ...
            $(document).keyup(function (event) {
                ...
                if (_this2.dialogIsOpen() && !$(event.target).is('input')) {
                    if (event.keyCode == 37) {
                        _this2.tabsController.prevTab();
                        $('#search').focus();
                    }
                    if (event.keyCode == 39) {
                        _this2.tabsController.nextTab();
                    }
                }
                // Esc closes dialog
                if (event.keyCode == 27) {
                ...
                if ($(event.target).is('#search')) {
                    ...
                    _this2.debounce(function (_) {
                        _this2.search($('#search').val(), function (items) {
                            _this2.buildResults(items);
                        });
                    }, 400);
                }
        ...
        value: function search(query, callback) {
            ...
            request.execute(function (response) {
                _this3.filterVideosOnly(response.result.items, function (items) {
                    _this3.getExtraInfo(items, function (items) {
                        callback(items);
                    });
                });
            });
        ...
        key: 'filterVideosOnly',
        value: function filterVideosOnly(items, callback) {
        ...
        key: 'getExtraInfo',
        value: function getExtraInfo(items, callback) {
            ...
            request.execute(function (response) {
                ...
                items = items.map(function (item) {
                    item.contentDetails = extraInfo.filter(function (extra) {
        ...
        key: 'buildResults',
        value: function buildResults(items) {
...
},{"../helpers/songs.js":12,"./TabsController.js":9,"jquery":13}],8:[function(require,module,exports){
'use strict';
        ...
        value: function buildControls() {
            ...
            document.addEventListener('keyup', function (event) {
                ...
                if (event.keyCode >= 48 && event.keyCode <= 57 && event.target.id !== "search") {
                    ...
                    if (sounds[number]) {
                        _this.play(sounds[number].id);
                    }
                }
            });
            container.addEventListener('click', function (event) {
                if (event.target.className === 'soundbite') {
                    var youtubeId = event.target.dataset.id;
                    _this.play(youtubeId);
                }
            });
        }
    }, {
...
},{"../config/config.js":2}],9:[function(require,module,exports){
"use strict";
...
var TabsController = function () {
    ...
    _createClass(TabsController, [{
        ...
        value: function addEventListeners() {
            ...
            this.container.querySelector(':scope > ul:first-child').addEventListener('click', function (e) {
                e.preventDefault();
                if (e.target.hash) {
                    _this.deselectLinks();
                    e.target.className = 'current';
                    _this.hideContents();
                    _this.showContents(e.target.hash);
                }
            });
        }
    }, {
        ...
        key: 'showContents',
        value: function showContents(hash) {
            this.container.querySelector(':scope > ' + hash).style.display = 'block';
        }
    }, {
        key: 'deselectLinks',
        value: function deselectLinks() {
        ...
        key: 'goToTab',
        value: function goToTab(id) {
            var tab = this.container.querySelector(':scope > ul:first-child > li:nth-child(' + id + ') > a');
            if (tab) {
                tab.click();
            }
        }
...
var GoogleApi = function () {
    ...
    _createClass(GoogleApi, [{
        ...
        value: function init() {
            ...
            function googleApiClientReady() {
                ...
                this.gapi.auth.init(function () {
                    _this.gapi.client.load('youtube', 'v3', function () {
                        if (_this.initCallbacks.length > 0) {
                            for (var i = 0; i < _this.initCallbacks.length; i++) {
                                _this.initCallbacks[i]();
                            }
                        }
                    });
                });
        ...
        key: 'getInfo',
        value: function getInfo(ids, callback) {
            ...
            snippetRequest.execute(function (snippetData) {
                detailsRequest.execute(function (detailsData) {
                    var items = snippetData.items.map(function (snippet) {
                        snippet.contentDetails = detailsData.items.filter(function (detail) {
...
exports.buildSongMarkup = buildSongMarkup;
var $ = require('jquery');
